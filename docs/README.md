...
| Document | Role |
|----------|------|
| [`../../Execution_System_Architecture.md`](../../Execution_System_Architecture.md) | **Target** architecture (multi-process OMS, nine RMS checks, etc.). Not a description of this FastAPI app. |
